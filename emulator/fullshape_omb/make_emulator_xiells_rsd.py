...
x0s = [0.02237, 0.1200,0.68, 0.73]; Nparams = len(x0s) # these are chosen to be roughly at the BOSS best fit value
...
derivs0 = compute_derivatives(Xi0grid, dxs, center_ii, 3)
derivs2 = compute_derivatives(Xi2grid, dxs, center_ii, 3)
derivs4 = compute_derivatives(Xi4grid, dxs, center_ii, 3)
